...
\begin{flalign*}
    & |m_n - 0| = |m_n| = \left|\frac{1}{n} \sum_{k=1}^{n} (-1)^n\right| & \text{| } \frac{1}{n} > 0 \\
    & = \frac{1}{n} \cdot \left|\sum_{k=1}^{n} (-1)^n\right| & \text{| Annahme } n \ge n_0 \text{ und } \frac{1}{n_0} < n_0 \\
    & \le \frac{1}{n_0} \cdot \left|\sum_{k=1}^{n_0} (-1)^n\right| & \text{| setze in \(n_0\) ein} \\
    & = \frac{1}{\left\lceil \frac{1}{n} \right\rceil + 1} \cdot \left|\sum_{k=1}^{n_0} (-1)^n\right| & \text{| Beobachte } max\left\{\left|\sum_{k=1}^{n_0} (-1)^n\right|\right\} = 1 \\
    & \le \frac{1}{\left\lceil \frac{1}{n} \right\rceil + 1} \cdot 1 = \frac{1}{\left\lceil \frac{1}{n} \right\rceil + 1} \\
