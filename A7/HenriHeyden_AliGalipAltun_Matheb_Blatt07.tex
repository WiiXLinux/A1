...
Angenommen \(x = \xi\) gilt, dann können wir zwar beide Seiten nicht durch \(\xi - x\) teilen und dieser Beweis funktioniert nicht. Beobachte aber, dass wenn \(\xi\), \(x\) annähert es trotzdem funktioniert, schließlich ist der Differenzenquotient so definiert, dass wir durch \(\xi - x\) teilen -- eine Summe, die sich an 0 annähert. \\
Somit gilt unserer Beweis annähernd für \(\xi - x \rightarrow 0\), jedoch nicht für \(\xi - x = 0\). \\ \\
